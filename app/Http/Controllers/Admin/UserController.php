...
class UserController extends Controller
{
    ...
    public function postUserEdit(Request $request, $id){
        ...
        if($u->save()):
            if($request->input('user_type') == "1"):
                ...
                return back()->with('message', 'El rango del usuario se actualizocon éxito')->with('typealert', 'success');
            endif;
        endif;
    ...
    public function postUserPermissions(Request $request, $id){
        ...
        if($u->save()):
                return back()->with('message', 'Los permisos de usuario fueron actualizados correctamente')->with('typealert', 'success');
            endif;
