...
document.addEventListener('DOMContentLoaded', function(){
	...
	if(route == "attractive_add"){
 		setSubCategoriesToProducts();
 	}



	if(route == "attractive_edit" && "hospedaje_edit"){
		setSubCategoriesToProducts();
	...
	if(route == "hospedaje_edit"){
		var btn_hospedaje_file_image = document.getElementById('btn_product_file_image');
		var hospedaje_file_image = document.getElementById('product_file_image');
			btn_hospedaje_file_image.addEventListener('click', function(){
				hospedaje_file_image.click();
			},false);

			hospedaje_file_image.addEventListener('change', function(){
				document.getElementById('form_product_gallery').submit()
			});
	}
